 ...
 */
var MissingBehavior = Fire.Class({
    ...
    properties: {
        ...
        //            }
        //            else {
        //                Fire.error('Can not find a behavior in the script which uuid is "%s".', value);
        //            }
        //        }
        //        else {
    ...
    onLoad: function () {
        Fire.warn('The referenced script on this Behavior is missing!');
    }
});
